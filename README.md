...
1. Clonar el repositorio: git clone https://github.com/lautiiv/Proyecto-gestor-de-turnos
...
- Realizar unos inserts para tener informacion en la base de datos
...
Edita db/config.ini con tus credenciales:
[database]
host = localhost
user = tu_usuario
