...
turno1 = Turno(2,2,2,"1/13/2025 10:00:00","RMN de Cerebro","ocupado")

@pytest.mark.parametrize("actual, esperado",[
    (turno1.id_turno, 2),
    (turno1.id_paciente, 2),
    (turno1.id_resonador, 2),
    (turno1.fecha_hora, "1/13/2025 10:00:00"),
...
turno2 = Turno(1,1,1,"1/13/2025 10:00:00","RMN Abdomen","Reservado")
...
def test_getter_fecha_hora():
    assert turno2.fecha_hora == "1/13/2025 10:00:00"
    
def test_getter_estudio():
    assert turno2.nombre_estudio == "RMN Abdomen"
    
def test_estado_setter():
    assert turno2.estado == "Reservado"
    
def test_setter_nombre_estudio():
    turno2.nombre_estudio = "RMN Torax"
    assert turno2.nombre_estudio == "RMN Torax"
    
def test_setter_estado():
    turno2.estado = "disponible"
    assert turno2.estado == "disponible"
